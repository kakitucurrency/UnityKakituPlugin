...
// These are settings which are needed to communicate with the Kakitu node.
config.node = {};
...
// The RPC server settings for communicating with the node. See "port" in config-rpc.toml of the Kakitu node
config.node.rpc = {};
...
config.dpow.ws_address = "wss://dpow.kakitu.org/service_ws/";
